...
Theorem rev_exercise1 : forall (l l' : list nat),
     ...
     l' = rev l.
Proof.
  intros l l' eq1. symmetry. rewrite -> eq1. rewrite -> rev_involutive. reflexivity. Qed.
(** [] *)
...
Example trans_eq_exercise : forall (n m o p : nat),
     ...
     (n + p) = (minustwo o).
Proof.
  intros n m o p eq1 eq2. rewrite <- eq1. rewrite -> eq2. reflexivity. Qed.
(** [] *)
...
Example inversion_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  x = y.
Proof.
  intros X x y z l j eq1 eq2. inversion eq1. inversion eq2. rewrite <- H0. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  - intros m eq2. destruct m.
    + inversion eq2.
    + inversion eq2. rewrite <- plus_n_Sm in H0. 
      simpl in H0. symmetry in H0.
      rewrite <- plus_n_Sm in H0. inversion H0.
      symmetry in H1. apply IHn' in H1. rewrite <- H1. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  - intros m eq1. destruct m.
    + inversion eq1.
    + apply f_equal. simpl in eq1. apply IHn' in eq1. rewrite <- eq1. reflexivity. Qed.
(** [] *)
...
Theorem nth_error_after_last: forall (n : nat) (X : Type) (l : list X),
     ...
     nth_error l n = None.
Proof.
  intros n X l. generalize dependent n. generalize dependent X. induction l as [| h l' IHl'].
- simpl. reflexivity.
- intros n eq1. destruct n.
  + simpl. inversion eq1.
  + simpl. apply IHl'. inversion eq1. reflexivity. Qed. 
(** [] *)
...
Proof.
  ...
  - destruct (f false) eqn:eq2.
    ...
    + rewrite -> eq2. rewrite -> eq2. reflexivity. Qed.
(** [] *)
...
Proof.
  intros n m. destruct ( beq_nat n m ) eqn:eq1.
  - apply beq_nat_true in eq1. rewrite <- eq1. rewrite <- beq_nat_refl. reflexivity.
  - destruct (beq_nat m n) eqn:eq2.
    + apply beq_nat_true in eq2. rewrite <- eq2 in eq1. rewrite <- beq_nat_refl in eq1.
