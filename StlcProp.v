...
(* No this property doesn't hold for STLC. *)
*)
(** [] *)
...
Proof.
intros. generalize dependent t2. induction H; intros t' H'; inversion H'; try subst; try reflexivity.
- rewrite H in H2. inversion H2. rewrite <- H1. reflexivity.
...
and the following typing rule:
    ...
    false, give a counterexample.
      ...
      - Determinism of [step]
(* Becomes false.
    tif ttrue ttrue ttrue ==> ttrue \/
    tif ttrue ttrue ttrue ==> zap *)
      - Progress
(* Remains true *)
      - Preservation
(* Remains true *)
...
(** $Date: 2017-11-16 11:42:16 -0500 (Thu, 16 Nov 2017) $ *)
