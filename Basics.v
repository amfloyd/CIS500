...
Example test_bin_incr1: incr O1 = S1 O1.
Proof. simpl. reflexivity. Qed.

Example test_bin_incr2: bin_to_nat ( incr O1 ) = 1.
Proof. simpl. reflexivity. Qed.

Example test_bin_incr3:  ( bin_to_nat O1 ) + 1  = 1.
Proof. simpl. reflexivity. Qed.

Example test_bin_incr4: incr ( S1 ( S1 ( O1 ) ) ) = S1 ( S1 ( S1 ( O1 ) ) ).
Proof. simpl. reflexivity. Qed.

Example test_bin_incr5: bin_to_nat ( S1 ( O1 ) ) = 1.
Proof. simpl. reflexivity. Qed.
(** [] *)

(** $Date: 2017-09-02 07:12:13 -0400 (Sat, 02 Sep 2017) $ *)
