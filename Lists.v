...
Definition member (v:nat) (s:bag) : bool :=
  match beq_nat 0 (count v s) with
  | true => false
  | false => true
  end.
...
Proof.
  intros l1 l2. induction l1 as [| n l1' IHn'].
  - simpl. rewrite -> app_nil_r. reflexivity.
  - simpl. rewrite <- app_assoc. rewrite -> IHn'. reflexivity. Qed.
...
Proof.
  intros l. induction l as [| n l' IHn'].
  - simpl. reflexivity.
  - simpl. rewrite -> rev_app_distr. rewrite -> IHn'. simpl. reflexivity. Qed.
...
Proof.
  intros l. induction l as [| n l' IHn'].
  - reflexivity.
  - simpl. induction n as [| n1 IHn1'].
    + simpl. rewrite <- IHn'. reflexivity.
    + simpl. rewrite <- IHn1'. reflexivity. Qed.
(** [] *)
...
Proof. intros l1 l2.
       intros H. rewrite <- rev_involutive. rewrite <- H. rewrite -> rev_involutive. reflexivity. Qed.
(** [] *)
...
Proof.
 intros d x v. simpl. destruct x. simpl.
...
Proof.
 intros d x y o.
 intros H. simpl. rewrite -> H. reflexivity. Qed.
(** [] *)
End PartialMap.
...
(* There are 2 constructors Baz1 and Baz2 but the number of elements is 0 because we can't create any element
of type baz. This can be done by assigning baz type to either Baz1 or Baz2. *)
*)
(** [] *)
