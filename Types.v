...
Example some_term_is_stuck :
  exists t, stuck t.
Proof.
  intros. unfold stuck. unfold step_normal_form. unfold not. exists (tsucc ttrue).
  split; intros.
  - try solve_by_invert. inversion H. inversion H0. inversion H2.
  - try solve_by_invert. inversion H.
    + inversion H0.
    + inversion H.
      * inversion H1.
...
Proof.
  unfold step_normal_form. unfold not. intros. destruct H0. induction t; try solve_by_invert;
...
Proof with auto.
  ...
  - inversion HE; subst...
  - inversion HE; subst... inversion HT. try solve_by_invert. apply H1.
  - inversion HE; subst...
Qed.
(** [] *)
...
Doing so would violate the progress property and hence cannot be achieved by removing the rule from
the definition.
*)
(** [] *)
...
(** $Date: 2017-11-07 11:41:45 -0500 (Tue, 07 Nov 2017) $ *)
